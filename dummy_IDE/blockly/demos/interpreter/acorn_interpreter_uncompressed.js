var mod$$inline_58 = function(a) {
    ...
    function r(a) {
        switch (a) {
            ...
            case 63:
                return ++g, e(ya);
            case 48:
                if (a = k.charCodeAt(g + 1), 120 === a || 88 === a) return g += 2, a = l(16), null == a && c(y + 2, "Expected hexadecimal number"), la(k.charCodeAt(g)) && c(g, "Identifier directly after number"), a = e(ba, a);
            case 49:
            case 50:
            case 51:
            case 52:
            ...
            case 39:
                ...
                return a;
            case 47:
                return a = k.charCodeAt(g + 1), R ? (++g, a = D()) : a = 61 === a ? u(U, 2) : u(za, 1), a;
            case 37:
            case 42:
                return a = k.charCodeAt(g + 1), a = 61 === a ? u(U, 2) : u(Cb, 1), a;
            case 124:
            case 38:
                return b = k.charCodeAt(g + 1), a = b === a ? u(124 === a ? Va : Wa, 2) : 61 ===
                    b ? u(U, 2) : u(124 === a ? Db : Eb, 1), a;
            case 94:
                return a = k.charCodeAt(g + 1), a = 61 === a ? u(U, 2) : u(Fb, 1), a;
            case 43:
            case 45:
                return b = k.charCodeAt(g + 1), b === a ? 45 == b && 62 == k.charCodeAt(g + 2) && na.test(k.slice(M, g)) ? (g += 3, h(), m(), a = A()) : a = u(Gb, 2) : a = 61 === b ? u(U, 2) : u(Hb, 1), a;
            case 60:
            case 62:
                return b = k.charCodeAt(g + 1), f = 1, b === a ? (f = 62 === a && 62 === k.charCodeAt(g + 2) ? 3 : 2, a = 61 === k.charCodeAt(g + f) ? u(U, f + 1) : u(Ib, f)) : 33 == b && 60 == a && 45 == k.charCodeAt(g + 2) && 45 == k.charCodeAt(g + 3) ? (g += 4, h(), m(), a = A()) : (61 === b && (f = 61 === k.charCodeAt(g + 2) ? 3 : 2),
                    a = u(Jb, f)), a;
            case 61:
            case 33:
                return b = k.charCodeAt(g + 1), a = 61 === b ? u(Kb, 61 === k.charCodeAt(g + 2) ? 3 : 2) : u(61 === a ? Aa : Xa, 1), a;
            case 126:
                return u(Xa, 1)
        }
        return !1
    ...
    function P(a) {
        var b = g,
            f = !1,
            d = 48 === k.charCodeAt(g);
        a || null !== l(10) || c(b, "Invalid number");
        46 === k.charCodeAt(g) && (++g, l(10), f = !0);
        a = k.charCodeAt(g);
        if (69 === a || 101 === a) a = k.charCodeAt(++g), 43 !== a && 45 !== a || ++g, null === l(10) && c(b, "Invalid number"), f = !0;
    ...
    function G() {
        ...
        switch (a) {
            ...
            case eb:
                t();
                var f = a === Ha;
                v(K) || qa() ? b.label = null : p !== V ? N() : (b.label = O(), W());
                ...
                e === x.length && c(b.start, "Unsyntactic " + a.keyword);
                return q(b, f ? "BreakStatement" : "ContinueStatement");
            case fb:
                return t(), W(), q(b, "DebuggerStatement");
            case gb:
                return t(), x.push(Ia), b.body = G(), x.pop(), w(Ja), b.test = ea(), W(), q(b, "DoWhileStatement");
            case hb:
                t();
                x.push(Ia);
                w(J);
                if (p === K) return Ka(b, null);
                if (p === La) return a = z(), t(), ib(a, !0), q(a, "VariableDeclaration"), 1 === a.declarations.length && v(ta) ? jb(b, a) : Ka(b, a);
                a = B(!1, !0);
                return v(ta) ? (ra(a), jb(b, a)) : Ka(b, a);
            case Ma:
                return t(),
                    Na(b, !0);
            case kb:
                return t(), b.test = ea(), b.consequent = G(), b.alternate = v(lb) ? G() : null, q(b, "IfStatement");
            case mb:
                return fa || c(y, "'return' outside of function"), t(), v(K) || qa() ? b.argument = null : (b.argument = B(), W()), q(b, "ReturnStatement");
            case Oa:
                t();
                b.discriminant = ea();
                b.cases = [];
                w(Z);
                for (x.push(Ob); p != T;) p === Pa || p === nb ? (a = p === Pa, e && q(e, "SwitchCase"), b.cases.push(e = z()), e.consequent = [], t(), a ? e.test = B() : (f && c(Da, "Multiple default clauses"), f = !0, e.test = null), w(aa)) : (e || N(), e.consequent.push(G()));
                e && q(e,
                    "SwitchCase");
                t();
                x.pop();
            ...
            case ob:
                return t(), na.test(k.slice(M, y)) && c(M, "Illegal newline after throw"), b.argument = B(), W(), q(b, "ThrowStatement");
            case pb:
                return t(), b.block = ga(), b.handler = null, p === qb && (a = z(), t(), w(J), a.param = O(), C && sa(a.param.name) && c(a.param.start, "Binding " + a.param.name + " in strict mode"), w(F), a.guard = null, a.body = ga(), b.handler = q(a, "CatchClause")), b.guardedHandlers = rb, b.finalizer = v(sb) ? ga() : null, b.handler || b.finalizer || c(b.start, "Missing catch or finally clause"),
                    q(b, "TryStatement");
            case La:
                return t(), ib(b), W(), q(b, "VariableDeclaration");
            case Ja:
                return t(), b.test = ea(), x.push(Ia), b.body = G(), x.pop(), q(b, "WhileStatement");
            case tb:
                return C && c(y, "'with' in strict mode"), t(), b.object = ea(), b.body = G(), q(b, "WithStatement");
            case Z:
                return ga();
            case K:
                return t(), q(b, "EmptyStatement");
            default:
                f = I;
                d = B();
                if (a === V && "Identifier" === d.type && v(aa)) {
                    for (e = 0; e < x.length; ++e) x[e].name === f && c(d.start, "Label '" + f + "' is already declared");
    ...
    function B(a, b) {
        ...
        if (!a && p === L) {
            var f = Q(c);
            for (f.expressions = [c]; v(L);) f.expressions.push(Qa(b));
    ...
    function Qa(a) {
        ...
        return p.isAssign ? (c = Q(b), c.operator = I, c.left = b, t(), c.right = Qa(a), ra(b), q(c, "AssignmentExpression")) : b
    }
    ...
    function Sa() {
        ...
        for (b = ha(ua()); p.postfix && !qa();) a = Q(b), a.operator = I, a.prefix = !1, a.argument = b, ra(b), t(), b = q(a, "UpdateExpression");
        return b
    }
    ...
    function ha(a, b) {
        ...
        return v(ja) ? (c = Q(a), c.object = a, c.property = B(), c.computed = !0, w(ka), ha(q(c, "MemberExpression"),
            b)) : !b && v(J) ? (c = Q(a), c.callee = a, c.arguments = Ta(F, !1), ha(q(c, "CallExpression"), b)) : a
    }
    ...
    function ua() {
        switch (p) {
            ...
            case da:
            case Ba:
                return a = z(), a.value = I, a.raw = k.slice(y, X), t(), q(a, "Literal");
            case vb:
            case wb:
            case xb:
                return a = z(), a.value = p.atomValue, a.raw = p.keyword, t(), q(a, "Literal");
            case J:
                var a = oa,
                    b = y;
                t();
            ...
            case ja:
                return a =
                    z(), t(), a.elements = Ta(ka, !0, !0), q(a, "ArrayExpression");
            case Z:
                a = z();
                b = !0;
                f = !1;
                ...
                for (t(); !v(T);) {
                    if (b) b = !1;
                    else if (w(L), n.allowTrailingCommas && v(T)) break;
                    var e = {
                            key: p === ba || p === da ? ua() : O(!0)
                        },
                        d = !1,
                        h;
                    v(aa) ? (e.value = B(!0), h = e.kind = "init") : 5 <= n.ecmaVersion && "Identifier" === e.key.type && ("get" === e.key.name || "set" === e.key.name) ? (d = f = !0, h = e.kind = e.key.name, e.key = p === ba || p === da ? ua() : O(!0), p !== J && N(), e.value = Na(z(), !1)) : N();
                    if ("Identifier" === e.key.type && (C || f))
                        for (var g = 0; g < a.properties.length; ++g) {
                            var m =
                                a.properties[g];
                            if (m.key.name === e.key.name) {
                                var l = h == m.kind || d && "init" === m.kind || "init" === h && ("get" === m.kind || "set" === m.kind);
                                l && !C && "init" === h && "init" === m.kind && (l = !1);
                                l && c(e.key.start, "Redefinition of property")
                            }
                        }
                    a.properties.push(e)
                }
            ...
            case Ma:
                return a = z(), t(), Na(a, !1);
            case yb:
                return a = z(), t(), a.callee = ha(ua(), !0), v(J) ? a.arguments = Ta(F, !1) : a.arguments = rb, a = q(a, "NewExpression");
            default:
                N()
        }
    }
    ...
    function Ta(a, b, c) {
        for (var f = [], e = !0; !v(a);) {
            if (e) e = !1;
            else if (w(L), b && n.allowTrailingCommas &&
                v(a)) break;
    ...
    var g, y, X, oa, ia, p, I, R, H, E, Da, M, Ea, fa, x, C, rb = [],
        ba = {
            type: "num"
        },
        Ba = {
...
Interpreter.prototype.step = function() {
    if (!this.stateStack.length) return !1;
...
Interpreter.prototype.initFunction = function(a) {
    var b = this,
        c;
    c = function(a) {
        for (var c = this.parent == b.FUNCTION ? this : b.createObject(b.FUNCTION), e = arguments.length ? arguments[arguments.length - 1].toString() : "", h = [], m = 0; m < arguments.length - 1; m++) h.push(arguments[m].toString());
        h = h.join(", ");
...
Interpreter.prototype.initObject = function(a) {
    ...
    c = function(a) {
        for (var c in this.properties)
            if (c == a) return b.createPrimitive(!0);
...
Interpreter.prototype.initArray = function(a) {
    ...
    d = function(a, e, d) {
        ...
        for (var m = b.createObject(b.ARRAY), r = a; r < a + e; r++) m.properties[m.length++] =
            this.properties[r], this.properties[r] = this.properties[r + e];
        for (r = a + e; r < this.length; r++) delete this.properties[r];
        this.length -= e;
    ...
    d = function(a, e) {
        ...
        0 > m && (m = this.length + m);
        var m =
            Math.max(0, Math.min(m, this.length)),
            r = c(e, this.length);
        0 > r && (r = this.length + r);
        for (var r = Math.max(0, Math.min(r, this.length)), A = 0; m < r; m++) {
            var u = b.getProperty(this, m);
            b.setProperty(d, A++, u)
        }
        return d
    };
    ...
    d = function(a) {
        ...
        for (m = 0; m < arguments.length; m++) {
            var A = arguments[m];
            if (b.isa(A, b.ARRAY))
                for (var u = 0; u < A.length; u++) r = b.getProperty(A, u), b.setProperty(c, d++, r);
...
Interpreter.prototype.initString = function(a) {
    ...
    c = function(a) {
        ...
        a = a ? a.data : void 0;
        a = c.match(a);
        if (null === a) return b.createPrimitive(null);
...
Interpreter.prototype.initDate = function(a) {
    var b = this,
        c;
    c = function(a, c, d, m, r, A, u) {
        var D = this.parent == b.DATE ? this : b.createObject(b.DATE),
            l = a;
        if (arguments.length)
            if (1 != arguments.length || "string" != l.type && !b.isa(l, b.STRING)) {
                for (var l = [], P = 0; P < arguments.length; P++) l[P] = arguments[P] ? arguments[P].toNumber() : void 0;
                D.date = 1 == l.length ? new Date(l[0]) : 2 == l.length ? new Date(l[0], l[1]) : 3 == l.length ? new Date(l[0], l[1], l[2]) : 4 == l.length ? new Date(l[0], l[1], l[2], l[3]) : 5 == l.length ? new Date(l[0], l[1], l[2], l[3], l[4]) :
                    6 == l.length ? new Date(l[0], l[1], l[2], l[3], l[4], l[5]) : new Date(l[0], l[1], l[2], l[3], l[4], l[5], l[6])
            } else D.date = new Date(l.toString());
...
Interpreter.prototype.createPrimitive = function(a) {
    if (void 0 === a && this.UNDEFINED) return this.UNDEFINED;
    if (a instanceof RegExp) return this.createRegExp(this.createObject(this.REGEXP), a);
    var b = typeof a;
    a = {
        data: a,
        isPrimitive: !0,
...
Interpreter.prototype.createObject = function(a) {
    ...
    this.isa(a, this.ARRAY) && (a.length = 0, a.toString = function() {
        for (var a = [],
                c = 0; c < this.length; c++) a[c] = this.properties[c].toString();
        return a.join(",")
    });
    return a
};
    ...
    if (a.doneCallee_) {
        ...
        if (b.arguments[c]) a.n_ = c + 1, this.stateStack.unshift({
            ...
            if (a.func_.node) {
                ...
                var e = this,
                    b = function(b) {
                        a.value = b || this.UNDEFINED;
                        e.stateStack.unshift(a);
                        e.paused_ = !1
                    },
...
Interpreter.prototype.stepUnaryExpression = function() {
    ...
    if (a.done) {
        ...
        else if ("!" == b.operator) a = a.value.isPrimitive ? !a.value.data : !a.value.toNumber();
        else if ("~" == b.operator) a = ~a.value.toNumber();
        else if ("typeof" == b.operator) a = a.value.type;
        else if ("delete" == b.operator) a.value.length ? (b = a.value[0], a = a.value[1]) : (b = this.getScope(), a = a.value), a = this.deleteProperty(b,
            a);
